...
import 'package:mechtronz/screens/tickets/controller/ticket_controller.dart';
                          ...
                          controlsBuilder: (context, details) => Row(
                            children: [
                              SizedBox(
                                ...
                                height: 40.h,
                                child: Button(
                                  loader: controller.isCreateLoading,
                                  ...
                                  child: Text(
                                    ...
                                    style:
                                        kBody.copyWith(color: AppColors.white),
                                  ),
                                ),
                              ),
                              if (_currentStep != 0)
                                TextButton(
                                  onPressed: controller.isCreateLoading
                                      ? null
                                      : () {
                                          setState(() {
                                            _currentStep -= 1;
            ...
            return Column(
              children: [
                Container(
                  color: AppColors.white,
                  child: Header(
                      title: 'Select Asset', leading: SizedBox(width: 40.w)),
                ),
                Expanded(
                  child: PaginatedListView(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        tileColor: asset.id == _selectedAsset?.id
                            ? AppColors.secondary.shade50
                            : AppColors.white,
                        leading: SquareInternetImage(
                          imgURL: asset.assetImagePath,
                          size: 50.w,
                        ),
                        title: Text(
                          asset.assetName ?? '',
